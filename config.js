...
function _applyReflectionsState(reflData) {
  ...
  syncSSRSettings();
  const row  = document.getElementById('reflSSRRow');
  const body = document.getElementById('reflSSRBody');
  row?.classList.toggle('active', !!ssrSettings.enabled);
  body?.classList.toggle('hidden', !ssrSettings.enabled);
