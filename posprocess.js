      ...
      fragmentShader: `
        ...
        void main(){
          ...
          if(uMode<0.5){
            ...
            // AO / Shadow: the AOV is interpreted as a mask where white =
            // fully lit / unoccluded and black = fully dark.
            c=b.rgb * mix(vec3(1.0), l.rgb, a);
          }else if(uMode<2.5){
            // Additive energy: emission/specular/reflection.
            c=b.rgb + l.rgb*a;
          }else{
            // Screen: useful for diffuse/beauty contributions.
            c=1.0-(1.0-b.rgb)*(1.0-l.rgb*a);
          }
