...
export function getViewportSize() {
  ...
  if (o && Number.isFinite(o.width) && Number.isFinite(o.height) && o.width > 0 && o.height > 0) {
...
export const app = {
  ...
  domainDrawing: false   // shader-system: true while the user is dragging out a Domain area
};
...
export function initScene(container = document.body) {
  ...
  renderer.domElement.addEventListener('pointerup', (event) => {
    ...
    // Modo de desenho de Domínio (shader-system) usa o mesmo canvas para
