...
export const PARTICLE_PRESETS = {
    ...
    energyAura: {
        ...
        texture: 'plasma', blending: 'additive',
    ...
    devilFruitAura: {
        ...
        texture: 'flame', blending: 'additive',
    ...
    goldCoins: {
        ...
        opacity: 1, opacityOverLife: [[0,0],[0.1,1],[0.7,1],[1,0]],
        texture: 'coin', blending: 'additive',
    ...
    fire: {
        ...
        icon:  '🔥',
        category: 'elemental',
        rate: 70, lifetime: [0.5, 1.1], speed: [0.6, 1.4],
        size: [0.14, 0.34], sizeOverLife: [[0,0.3],[0.25,1],[0.65,0.85],[1,0]],
        color: { from: 0xfff2b0, to: 0xff2200 },
        colorOverLife: [[0,0xfff2b0],[0.2,0xffcc33],[0.45,0xff8800],[0.7,0xff3300],[1,0x330000]],
        opacity: 1, opacityOverLife: [[0,0],[0.1,1],[0.55,0.85],[1,0]],
        texture: 'flame', blending: 'additive',
        emitShape: 'line', targetOffset: { x: 0, y: 1.4, z: 0 }, lineJitter: 0.18,
        drag: 0.92, gravity: -0.6,
        heatShimmer: 0.18,
        spiralStrength: 2.5,
        lightEmission: 1.0,
    },
    ...
    campfire: {
        ...
        icon:  '🏕️',
        category: 'elemental',
        rate: 55, lifetime: [0.6, 1.5], speed: [0.5, 1.3],
        size: [0.09, 0.24], sizeOverLife: [[0,0.3],[0.25,1],[0.6,0.75],[1,0]],
        color: { from: 0xffffff, to: 0xff3300 },
        colorOverLife: [[0,0xfff0a0],[0.2,0xffcc00],[0.45,0xff7700],[0.75,0xff2200],[1,0x330000]],
        opacity: 0.95, opacityOverLife: [[0,0],[0.1,0.95],[0.55,0.75],[1,0]],
        texture: 'ember', blending: 'additive',
        emitShape: 'line', targetOffset: { x: 0, y: 1.0, z: 0 }, lineJitter: 0.22,
        drag: 0.9, gravity: -0.5,
        heatShimmer: 0.22,
        spiralStrength: 1.5,
        lightEmission: 1.0,
    },
